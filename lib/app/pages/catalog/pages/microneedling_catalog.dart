...
class MicroneedlingCatalog extends StatelessWidget {
  const MicroneedlingCatalog({
  ...
  Widget build(BuildContext context) {
    return MicroneedlingView(perimeter: perimeter);
  }
}

class MicroneedlingView extends StatefulWidget {
  const MicroneedlingView({
    super.key,
    required this.perimeter,
  });
  ...
  @override
  State<MicroneedlingView> createState() => _MicroneedlingViewState();
}

class _MicroneedlingViewState extends State<MicroneedlingView> {
  String botoxName = "";
