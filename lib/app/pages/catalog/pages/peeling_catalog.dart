...
class PeelingCatalog extends StatelessWidget {
  const PeelingCatalog({
  ...
  Widget build(BuildContext context) {
    return PeelingMobileView(perimeter: perimeter);
  }
}

class PeelingMobileView extends StatefulWidget {
  const PeelingMobileView({
    super.key,
    required this.perimeter,
  });
  ...
  @override
  State<PeelingMobileView> createState() => _PeelingMobileViewState();
}

class _PeelingMobileViewState extends State<PeelingMobileView> {
  String botoxName = "";
