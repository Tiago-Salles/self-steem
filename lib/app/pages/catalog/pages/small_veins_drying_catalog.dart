...
class SmallVeinsDryingCatalog extends StatelessWidget {
  const SmallVeinsDryingCatalog({
  ...
  Widget build(BuildContext context) {
    return SmallVeinsDryingMobileView(perimeter: perimeter);
  }
}

class SmallVeinsDryingMobileView extends StatefulWidget {
  const SmallVeinsDryingMobileView({
    super.key,
    required this.perimeter,
  });
  ...
  @override
  State<SmallVeinsDryingMobileView> createState() =>
      _SmallVeinsDryingMobileViewState();
}

class _SmallVeinsDryingMobileViewState
    extends State<SmallVeinsDryingMobileView> {
  String botoxName = "";
      ...
      child: Column(
        children: [
          ...
          SizedBox(
            ...
            child: Text(
              "Secagem de vasinho (Escleroterapia com glicose)",
              style: TextStyle(
